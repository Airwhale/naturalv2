...
class SvT:
    def __init__(self, nct_id="NCT03987919", split="train", path_to_main=""):
        ...
        self.covariate_names = ["age", "sex", "bmi", "start_HbA1c", "start_weight", "duration_days"]
        self.extended_names = [
            "age", "sex", "country", "t2dm", "metformin", "bmi",
    ...
    def get_options(self, feature_names):
        options = {
            ...
            "treatment": ["Semaglutide like Ozempic or Wegovy or Rybelsus", "Tirzepatide like Mounjaro or Zepbound"], # treatment
